package com.java.renyi.LDA.me.xiaosheng.lda;

import java.io.IOException;
import java.util.Map;

import com.java.renyi.LDA.com.hankcs.lda.Corpus;
import com.java.renyi.LDA.com.hankcs.lda.LdaGibbsSampler;
import com.java.renyi.LDA.com.hankcs.lda.LdaUtil;
import com.java.renyi.LDA.com.hankcs.lda.Vocabulary;
...
public class HanLDA {
     ...
     * 预测文档的主题分布
     * @param modelFilePath 模型文件路径
     * @param str String Ready To Be Inferenced
     * @param printResult 是否打印预测结果
     * @return 主题分布数组
     * @throws IOException
     */
    public static double[] inferenceFromString(LDAModel ldaModel, String str, boolean printResult)  {
        int[] document = Corpus.loadString(str, ldaModel.getVocabulary());
        //进行文档的主题分布预测
        double[] tp = LdaGibbsSampler.inference(ldaModel.getPhiMatrix(), document);
        if (printResult) {
            for(int i = 0; i < tp.length; i++) {
