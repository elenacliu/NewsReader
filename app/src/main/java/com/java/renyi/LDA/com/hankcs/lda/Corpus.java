 ...
 * </copyright>
 */
package com.java.renyi.LDA.com.hankcs.lda;
...
public class Corpus
{
    ...
    public static int[] loadString(String str, Vocabulary vocabulary)  {
        ...
        int i = 0;
        Integer integer;
        for(Iterator var14 = wordList.iterator(); var14.hasNext(); result[i++] = integer) {
            integer = (Integer)var14.next();
        }
        return result;
    }
}
